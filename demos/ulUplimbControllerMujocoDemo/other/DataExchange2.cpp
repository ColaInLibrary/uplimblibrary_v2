...
extern void getDriverInfo(void* info);
extern void sendDriverInfo(void* info);
...
void DataExchange::initialize(int dof) {
  dof_ = dof;
  std::cout << "DataExchange initialized with DOF: " << dof_ << std::endl;
}
