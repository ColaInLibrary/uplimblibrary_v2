#ifndef UL_MATH_QUATERNIONPOLYNOMIAL_H
#define UL_MATH_QUATERNIONPOLYNOMIAL_H
...
class Polynomial<Quaternion> : public Function<Quaternion> {
 public:
  Polynomial<Quaternion>() : Function<Quaternion>(0, 0), y0(), c() {}

  Polynomial<Quaternion>(const ::std::size_t& degree) : Function<Quaternion>(0, 0), y0(), c(degree + 1) {}
  ...
  Polynomial<Quaternion>* clone() const { return new Polynomial<Quaternion>(*this); }

  Vector3& coefficient(const ::std::size_t& i) { return this->c[i]; }

  const Vector3& coefficient(const ::std::size_t& i) const { return this->c[i]; }
...
#endif  // UL_MATH_QUATERNIONPOLYNOMIAL_H
