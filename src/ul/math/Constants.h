#ifndef UL_MATH_CONSTANTS_H
#define UL_MATH_CONSTANTS_H
...
constexpr T Constants<T, Enable>::e;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::log2e;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::log10e;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::pi;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::inv_pi;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::inv_sqrtpi;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::ln2;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::ln10;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::sqrt2;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::sqrt3;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::inv_sqrt3;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::egamma;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::phi;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::gravity;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::deg2rad;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::rad2deg;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::giga2unit;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::kilo2unit;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::mega2unit;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::micro2unit;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::milli2unit;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::nano2unit;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::unit2giga;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::unit2kilo;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::unit2mega;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::unit2micro;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::unit2milli;
template <typename T, typename Enable>
constexpr T Constants<T, Enable>::unit2nano;

typedef Constants<Real> constants;
}  // namespace math
}  // namespace ul

#endif  // UL_MATH_CONSTANTS_H
