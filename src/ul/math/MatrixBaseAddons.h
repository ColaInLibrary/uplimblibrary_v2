...
#ifndef UL_SRC_UL_MATH_MATRIXBASEADDONS_H_
#define UL_SRC_UL_MATH_MATRIXBASEADDONS_H_
...
#ifdef UL_EIGEN_MATRIXBASE_PLUGIN
#include UL_EIGEN_MATRIXBASE_PLUGIN
#endif

#endif  // UL_SRC_UL_MATH_MATRIXBASEADDONS_H_
